...
const translations = {
  tr: {
    ...
    stepInstallText: "Aşağıdaki düğmeye basın ve cihazınızı seçin.",
    ...
    successText: "Cihaz yeniden başlatılıyor. Birkaç saniye bekleyin.",
    connectionErrorTitle: "Cihazla bağlantı kurulamadı",
    connectionErrorText: "Seri monitörü kapatın. BOOT’a basılı tutup RESET/RST’ye bir kez basın, ardından BOOT’u bırakıp tekrar deneyin.",
  ...
  en: {
    ...
    stepInstallText: "Press the button below and select your device.",
    ...
    successText: "The device is restarting. Wait a few seconds.",
    connectionErrorTitle: "Could not connect to the device",
    connectionErrorText: "Close the serial monitor. Hold BOOT, press and release RESET/RST once, then release BOOT and try again.",
